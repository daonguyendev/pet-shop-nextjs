            ...
            <div className="col-lg-7">
              <div className="tab-content tab-content1" id="v-pills-tabContent">
                ...
                >
                  <img
                    className="img-fluid"
                    src="https://scooby-nextjs.vercel.app/assets/images/bg/card-big-01.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="img-fluid"
                    src="https://scooby-nextjs.vercel.app/assets/images/bg/card-big-02.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="img-fluid"
                    src="https://scooby-nextjs.vercel.app/assets/images/bg/card-big-03.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="img-fluid"
                    src="https://scooby-nextjs.vercel.app/assets/images/bg/card-big-04.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="img-fluid"
                    src="https://scooby-nextjs.vercel.app/assets/images/bg/card-big-05.png"
                    alt=""
                  />
                </div>
              </div>
              ...
              >
                <button
                  ...
                  aria-selected="true"
                >
                  <img src="https://scooby-nextjs.vercel.app/assets/images/bg/card-sm-01.png" alt="" />
                </button>
                <button
                  className="nav-link"
                  id="v-pills-img2-tab"
                  ...
                  aria-selected="false"
                >
                  <img src="https://scooby-nextjs.vercel.app/assets/images/bg/card-sm-02.png" alt="" />
                </button>
                <button
                  className="nav-link"
                  id="v-pills-img3-tab"
                  ...
                  aria-selected="false"
                >
                  <img src="https://scooby-nextjs.vercel.app/assets/images/bg/card-sm-03.png" alt="" />
                </button>
                <button
                  className="nav-link"
                  id="v-pills-img4-tab"
                  ...
                  aria-selected="false"
                >
                  <img src="https://scooby-nextjs.vercel.app/assets/images/bg/card-sm-04.png" alt="" />
                </button>
                <button
                  className="nav-link"
                  id="v-pills-img5-tab"
                  ...
                  aria-selected="false"
                >
                  <img src="https://scooby-nextjs.vercel.app/assets/images/bg/card-sm-05.png" alt="" />
                </button>
              </div>
            </div>
                  ...
                  <form>
                    <div className="row g-4">
                      ...
                      <div className="pyment-method">
                        ...
                        <ul>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/visa2.svg" alt="" />
                          </li>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/amex.svg" alt="" />
                          </li>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/discover.svg" alt="" />
                          </li>
                          <li>
                            <img
                              src="https://scooby-nextjs.vercel.app/assets/images/icon/mastercard.svg"
                              alt=""
                            />
                          </li>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/stripe.svg" alt="" />
                          </li>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/paypal.svg" alt="" />
                          </li>
                          <li>
                            <img src="https://scooby-nextjs.vercel.app/assets/images/icon/pay.svg" alt="" />
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-6">
                      <div className="services-dt-img">
                        <img
                          className="img-fluid"
                          src="https://scooby-nextjs.vercel.app/assets/images/bg/services-dt-immg.png"
                          alt=""
                        />
                      </div>
                    </div>
                          ...
                          <ul className="review-list">
                            <li>
                              <div className="single-review d-flex justify-content-between flex-md-nowrap flex-wrap">
                                <div className="review-image">
                                  <img
                                    src="https://scooby-nextjs.vercel.app/assets/images/bg/review-img-1.png"
                                    alt="image"
                                  />
                                </div>
                            ...
                            <li>
                              <div className="single-review d-flex justify-content-between flex-md-nowrap flex-wrap">
                                <div className="review-image">
                                  <img
                                    src="https://scooby-nextjs.vercel.app/assets/images/bg/review-img-3.png"
                                    alt="image"
                                  />
                                </div>
                                <div className="review-content">
